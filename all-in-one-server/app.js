...
app.use(
  "/user",
  Express.Router().post("/register", async (req, res) => {
...
app.use(
  "/user",
  Express.Router().post("/user/login", async (req, res) => {
    let { email, password } = req.body.user;
...
app.use(
  "/journal",
  Express.Router().post("/new", validateJWT, async (req, res) => {
...
app.use(
  "/journal",
  Express.Router().get("/mine", validateJWT, async (req, res) => {
    let { id } = req.user;
    try {
...
app.use(
  "/journal",
  Express.Router().get("/:title", async (req, res) => {
...
app.use(
  "/journal",
  Express.Router().put("/update/:entryId", validateJWT, async (req, res) => {
    const { title, date, entry } = req.body.journal;
...
Express.Router().delete("/delete/:id", validateJWT, async (req, res) => {
